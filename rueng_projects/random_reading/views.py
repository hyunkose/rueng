...
def article_detail(request):
    ...
    yesasia_urls = ["yesasia_article_list/not-read-only/"+str(obj.article_id) for obj in yesasia_ids]
    yandex_urls = ["yandex_article_list/not-read-only/"+obj.article_id for obj in yandex_ids]
